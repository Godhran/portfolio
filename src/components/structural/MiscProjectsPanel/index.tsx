...
const MiscProjectsPanel = () => {
  ...
  return (
    <section id="Misc" className="mt-5" data-aos="fade-up">
      <div className="w-100" style={styles.textPanel}>
        <div className="container mx-auto">
          <div className="row row-cols-1">
            <div className="col flex flex-col justify-content-center p-4 md:rounded">
              <div className="container">
                <div className="grid grid-cols-2   gap-2 place-content-between">
                  ...
                  <RoundedButton
                    onClick={() => {
                      setVisibleSection(
                        visibleSection === copy.web ? "" : copy.web
                      );
                    }}
                    dataToggle="collapse"
                    ariaExpanded={false}
                ...
                <div className="row">
                  ...
                  >
                    {visibleSection === copy.web ? (
                      <div
                        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 place-items-center justify-center mt-5"
                        data-testid={testIds.WebProjects}
                      >
                        <ProjectButton
                          image={BOJJI}
                          title={"BOJJI"}
