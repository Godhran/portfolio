...
const WoahYouGoBigGuy = () => {
  ...
  const styles = {
    ...
    lines: {
      fill: !minimalMode ? colours.vibrant.dark : colours.minimal.dark,
    },
    eyes: {
    ...
    main: {
      fill: !minimalMode ? colours.vibrant.c : colours.minimal.accent,
    },
    bangle: {
      fill: !minimalMode ? colours.vibrant.f : colours.minimal.accent,
    },
    secondary: {
      fill: !minimalMode ? colours.vibrant.e : colours.minimal.light,
    },
    teeth: {
      fill: !minimalMode ? colours.vibrant.a : colours.minimal.light,
    },
    hair: {
      fill: !minimalMode ? colours.vibrant.dark : colours.minimal.light,
    },
  };
          ...
          <g>
            ...
            {minimalMode ? (
              <>
                ...
                <path
                  style={styles.skin}
                  d="M733.9,547l9-7l7-13l6,11l11,11l-7.42,10.11c-2.22,3.03-5.88,4.67-9.62,4.31l0,0
